...
func getPlatformTools() error {
	plaformToolsUrlMap := map[[2]string]string{
		...
		[2]string{"linux", "37.0.1"}: "http://release.calyxos.org/device-flasher/platform-tools/platform-tools_r37.0.1-linux.zip",
		...
		[2]string{"windows", "37.0.1"}: "http://release.calyxos.org/device-flasher/platform-tools/platform-tools_r37.0.1-windows.zip",
	}
