...
// Source: gitlab.com/calyxos/device-flasher/internal/flash (interfaces: FactoryImageFlasher,PlatformToolsFlasher,ADBFlasher,FastbootFlasher,UdevFlasher)
...
// MockUdevFlasher is a mock of UdevFlasher interface
type MockUdevFlasher struct {
	ctrl     *gomock.Controller
	recorder *MockUdevFlasherMockRecorder
}

// MockUdevFlasherMockRecorder is the mock recorder for MockUdevFlasher
type MockUdevFlasherMockRecorder struct {
	mock *MockUdevFlasher
}

// NewMockUdevFlasher creates a new mock instance
func NewMockUdevFlasher(ctrl *gomock.Controller) *MockUdevFlasher {
	mock := &MockUdevFlasher{ctrl: ctrl}
	mock.recorder = &MockUdevFlasherMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockUdevFlasher) EXPECT() *MockUdevFlasherMockRecorder {
	return m.recorder
}

// Setup mocks base method
func (m *MockUdevFlasher) Setup() error {
	m.ctrl.T.Helper()
...
func (mr *MockUdevFlasherMockRecorder) Setup() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Setup", reflect.TypeOf((*MockUdevFlasher)(nil).Setup))
}
